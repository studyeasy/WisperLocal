...
<p align="center">
  ...
  <a href="https://tools.dubnext.com/download/WisperLocal-Setup-0.6.4.exe"><img src="https://img.shields.io/badge/Direct%20download-WisperLocal--Setup.exe-2563EB?style=for-the-badge&logo=windows&logoColor=white" alt="Direct download WisperLocal installer"></a>
</p>

Get **`WisperLocal-Setup.exe`** from **[tools.dubnext.com](https://tools.dubnext.com/tools/whisper-local)** or [download it directly](https://tools.dubnext.com/download/WisperLocal-Setup-0.6.4.exe) and run it — it's a **per-user installer, no admin required**. A 🎙️ icon then appears in your system tray. (Optional AI enhancement needs nothing extra — the model downloads itself on first use.)
